/**
 * MODE_MAP and EVENT_MAP derived from hardware analysis logic
 */
const MODE_MAP = {
  "1": "nCPAP",
  "2": "HFNC",
 ...
 */
const generateSessionReport = (logText) => {
  if (!logText) return [];
 ...
 */
const getGraphData = (logText, targetPC, targetSession) => {
  if (!logText) return [];
...
// EXPORTS - Using the single export block required for ES Modules
export { 
